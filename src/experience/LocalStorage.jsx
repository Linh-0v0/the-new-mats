...
export default class LocalStorage {
  ...
  initPlayerState() {
    ...
    if (
      ...
      this.stringState.playerPosition = localStorage.getItem("playerPosition");
      this.stringState.playerRotation = localStorage.getItem("playerRotation");
    } else {
      localStorage.setItem("playerPosition", this.stringState.playerPosition);
      localStorage.setItem("playerRotation", this.stringState.playerRotation);
    }
  }
  ...
  setStateObject() {
    this.state = {
      ...
      rotX: Number(this.stringState.playerPosition.split("|")[1]),
      rotY: Number(this.stringState.playerPosition.split("|")[2]),
      rotZ: Number(this.stringState.playerPosition.split("|")[3]),
    };
  }
